...
# Configuration
CONFIG_OUTPUT="/home10/anonymouspi/Media" # if this script is called by the deluge user, then $HOME will NOT refer to YOUR user home, but paths such as /var/lib/deluge instead
